...
<head>
    ...
    <title> Vehiculos Disponibles || Venta de Autos, S.A </title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            VEHICULOS || <small>VEHICULOS DISPONIBLES PARA SUBASTAR</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-comment"></i> Subastas Disponibles
                            </li>
                            <li class="active">
                ...
                <div class="row">
                  ...
                  <?php
                      ...
                      if($res->num_rows > 0){
                        ...
                        echo "<h3>POR EL MOMENTO NO HAY SUBASTAS DISPONIBLES</h3>";
                      }
