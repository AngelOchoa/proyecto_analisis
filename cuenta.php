...
<head>
    ...
    <title>MI CARRITO || Venta de Autos, S.A</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="subastas.php"> <br>
                  SUBASTAS DISPONIBLES <i class="fa fa-search"></i></a>
            </div>
            <!-- Top Menu Items -->
            <?php
              include ("header.php");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <i class="fa fa-user"></i>    MI CUENTA || <small> <i class="fa fa-car"></i> VEHICULOS SUBASTADOS</small>
                        </h1>
                        <ol class="breadcrumb">
                          <li>
                          ...
                          <li class="active">
                              <i class="fa fa-child"></i> Mi Cuenta: <font color="blue"><?php echo $_SESSION["nomb_comp"]; ?></font> 
                          </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="table-responsive" style="text-align: center;">
                      <h2> <font color="blue"><i class="fa fa-check"></i></font> SUBASTAS ACTIVAS</h2>
                      <hr>
                ...
                <!-- Inicia subastas mias que ya fueron vendidas -->
                  <div class="col-lg-6">
                    ...
                    <div class="table-responsive" style="text-align: center;">
                      <h2> <font color="red"><i class="fa fa-lock"></i></font>  SUBASTAS CERRADAS</h2>
                      <hr>
                        <table class="table table-hover">
                            <thead>
                                <tr>
