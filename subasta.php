...
<head>
    ...
    <title>Subasta del Vehiculo || Venta de Autos, S.A</title>
      ...
      if (isset($_POST["ofertar"])) {
        ...
        $fecha_hora_actual = date("Y-m-d H:i:s");
          ...
          if($oferta == $max){
            ...
            if($res_1 == false){
              ...
              if($res_2 == false){
                echo "<script>alert('No se pudo agregar el Vehiculo al carrito');</script>";
              }else{
                ...
                if($res_2_1 == false){
                  ...
                  echo "<script>alert('1... 2... 3... ¡VEHICULO VENDIDO CON EXITO!');</script>";
                }
              }
            }
          }else{
        ...
        $fecha_hora_actual = date("Y-m-d h:i:s");
          ...
          if($res_1 == false){
            ...
            $res_2 = $bd->query("INSERT into cesta(id_usuario, id_subasta) values($id_user_1,$id_sub_1);");
            if($res_2 == false){
              echo "<script>alert('No se pudo agregar vehiculo');</script>";
            }else{
              $res_2_1 = $bd->query("UPDATE subasta set estado=1, comprador=$id_user_1 where id_subasta=$id_sub_1;");
              if($res_2_1 == false){
                echo "<script>alert('No se pudo actualizar la subasta');</script>";
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> <i class="fa fa-home"></i> Estas Subastando por un Vehiculo Disponible... </a>
            </div>
            <!-- Top Menu Items -->
            <?php
              include ("header.php");
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> <i class="fa fa-car"></i>
                            Vehiculo Disponible || <small> Haz tu mejor oferta...!!!</small> 
                        </h1>
                        <ol class="breadcrumb">
                                      ...
                                      <div class="caption">
                                        <?php
                                          if($estado == 1 && $ofertante_comp != null){
                                            echo "<h1 class='text-danger'> VEHICULO VENDIDO </h1>";
                                          }
                                        ?>
                                        ...
                                        <p>Vehiculo publicado el: <?php echo "<b>$ini</b>"; ?></p>
                                        ...
                                        <h4>Oferta Actual: <b class="text-danger">
                                          <?php echo "Q$oferta.00"; ?></b></h4>
                                      ...
                                      <div class="col-sm-6 col-md-6">
                                        <div class="thumbnail">
                                          ...
                                          <div class="caption">
                                            ...
                                            <p class="text-warning text-right"><i class="fa fa-tag"></i> <?php echo $categoria; ?></p>
                                            <hr style="margin: 1px 1px 1px 1px;">
                                            <p> El Vehiculo se ha publicado el: <?php echo "<b>$ini</b>"; ?></p>
                                            <p><?php //print $interval->format('%R %a días %H horas %I minutos'); ?></p>
                                            ...
                                            <form class="form-inline" action="" method="post">
                                              ...
                                              <?php
                                                if($_SESSION["id_usuario"] == $subastador){
                                                  ...
                                                  <button type="submit" disabled class="btn btn-info" name="ofertar">Subastar</button>
                                                  <button type="submit" disabled class="btn btn-success" name="comprar">Comprar Ahora</button>
                                                  <?php
                                                }else{
                                                  ?>
